...
export const TheaterForm = props => {
    ...
    React.useEffect(() => setAutoCompleteValue(), [])
    const setAutoCompleteValue = async () => {
        setValue(props?.user?.user?.theater?._source?.formatted_address)
    };
    ...
    const {
        values: { theater_name, theater_address, theater_city, theater_state, theater_zip, theater_description, 
            theater_phone, theater_email, theater_website, image_file_name, 
    ...
    return (
        <Form autoComplete="off" id='theater-update-form'>
            <Row>
                <Col md='6' className='theater_name'>
                    <TextField
                        ...
                        helperText={errors.theater_name}
                        value={theater_name}
                        InputProps={{
                            startAdornment: (
                ...
                <Col md='6' className='theater-map-location'>
                    {/* <FormControl error={(errors.theater_map_location) ? true : null} style={{ width: '100%' }} >
                        <InputGroup >
                            <InputGroup.Prepend>
                            ...
                            <Autocomplete
                                id="theater_map_location"
                                className='form-control'
                                placeholder="Locality on Google Map"
                                value={theater_map_location}
                                apiKey={process.env.REACT_APP_GOOGLE_MAP_API_KEY}
                                onPlaceSelected={(place) => {
                                    console.log('PLACE:', place);
                                    setFieldValue("theater_map_location", place.formatted_address);
                                    setFieldValue("theater_map_place_id", place.place_id);
                                    setFieldValue("theater_map_long", place.geometry.location.lng());
                                    setFieldValue("theater_map_lat", place.geometry.location.lat());
                                }
                                }
                                onChange={handleChange}
                                options={{
                            ...
                            <InputGroup.Append>
                                <InputGroup.Text id="basic-addon2">
                                    {SHARED_ICONS?.BsSearch}
                                    </InputGroup.Text>
                            </InputGroup.Append>
                        </InputGroup>
                        <FormHelperText className='error-field'>{errors.theater_map_location}</FormHelperText>
                    </FormControl> */}
                ...
                <Col md='6' className='theater_address'>
                    <TextField
                        ...
                        variant="outlined"
                        className={classes.textField}
                        helperText={errors.theater_address}
                ...
                <Col md='6' className='theater_city'>
                    <TextField
                        ...
                        variant="outlined"
                        className={classes.textField}
                        helperText={errors.theater_city}
                        value={theater_city}
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                ...
                <Col md='6' className='theater_state'>
                    <TextField
                        ...
                        variant="outlined"
                        className={classes.textField}
                        helperText={errors.theater_state}
                        value={theater_state}
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                ...
                <Col md='12' className='theater_description'>
                    <TextField
                        ...
                        multiline
                        className={classes.textField}
                        helperText={errors.theater_description}
                ...
                <Col md='6' className='theater_email'>
                    <TextField
                        ...
                        variant="outlined"
                        className={classes.textField}
                        helperText={errors.theater_email}
                        value={theater_email}
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                ...
                <Col md='6' className='website'>
                    <TextField
                        ...
                        variant="outlined"
                        className={classes.textField}
                        helperText={errors.theater_website}
